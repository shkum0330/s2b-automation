...
# [수정] QWebEngineSettings는 더 이상 여기서 필요하지 않습니다.
...
class PaymentWindow(QDialog):
    ...
    def __init__(self, client_key, order_id, order_name, amount, parent=None):
        ...
        # --- [수정] ---
        # 이 블록을 반드시 제거해야 합니다. (main.py에서 전역으로 설정함)
